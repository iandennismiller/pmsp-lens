...
set weights_path "/home/idm/scratch/pmsp-weights/pmsp-study-3-replication-5"
set examples_path "../../../usr/examples"
set results_path "../../../var/results/2021-03-14-omni"
...
for { set epoch $start_epoch } { $epoch <= $end_epoch } { incr epoch 5 } {
